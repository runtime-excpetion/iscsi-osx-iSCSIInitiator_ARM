...
Because I am not an Apple developer and do not have a corresponding certificate, I cannot compile KEXT for subsequent operations. Others can compile based on this project.
